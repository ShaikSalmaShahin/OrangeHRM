...
public class CapturingCompleteWebTableDataWithCount extends BaseTest {
	...
	public static void main(String[] args) {
		...
		CapturingCompleteWebTableDataWithCount getTableData = new CapturingCompleteWebTableDataWithCount();
